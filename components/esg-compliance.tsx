          ...
          >
            <div className="flex items-center justify-between mb-2 sm:mb-3">
              ...
              {metric.status === "compliant" ? (
                ...
                <AlertCircle className="h-4 w-4 sm:h-5 sm:w-5 text-[oklch(0.75_0.20_60)] flex-shrink-0" />
              )}
            </div>
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="text-base sm:text-lg font-bold flex-shrink-0" style={{ color: metric.color }}>
                {metric.score}%
              </span>
            </div>
          </div>
