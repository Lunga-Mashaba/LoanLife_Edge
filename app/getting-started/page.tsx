...
export default function LandingPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-[oklch(0.12_0.02_250)] via-[oklch(0.10_0.03_240)] to-[oklch(0.12_0.02_250)] gradient-animate">
      <Sidebar />
        ...
        <main className="flex-1 overflow-y-auto">
          <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
                ...
                <div className="relative">
                  <h1 className="text-7xl md:text-8xl font-bold mb-6 leading-tight">
                    <span
                      ...
                      style={{
                        textShadow: "0 0 80px rgba(34, 211, 238, 0.5), 0 0 120px rgba(168, 85, 247, 0.3)",
                      }}
                    >
                      LoanLife
                    </span>
                    ...
                    <span
                      ...
                      style={{
                        textShadow: "0 0 80px rgba(236, 72, 153, 0.5), 0 0 120px rgba(34, 211, 238, 0.3)",
                      }}
                    >
                      EDGE
                    </span>
              ...
              <p className="text-2xl md:text-3xl text-cyan-300 mb-4 font-light tracking-wide">
                AI-Powered Loan Risk Management
              </p>
              <p className="text-lg text-purple-300/80 mb-12 max-w-3xl mx-auto leading-relaxed">
              ...
              <div className="flex gap-6 justify-center mb-16">
                <Link href="/login">
                  <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-lg px-12 py-6 rounded-xl font-semibold transition-all duration-300 transform hover:scale-110 shadow-[0_0_30px_rgba(34,211,238,0.5)] hover:shadow-[0_0_50px_rgba(34,211,238,0.8)]">
                ...
                <Button
                  variant="outline"
                  className="border-2 border-pink-500 text-pink-400 hover:bg-pink-500/10 text-lg px-12 py-6 rounded-xl font-semibold transition-all duration-300 transform hover:scale-110 shadow-[0_0_30px_rgba(236,72,153,0.3)] hover:shadow-[0_0_50px_rgba(236,72,153,0.6)] bg-transparent"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 transform hover:scale-105 transition-all duration-300"
                    style={{
          ...
          <section className="py-20 px-6 relative">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-center text-purple-300/70 text-xl mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                >
                  ...
                  <div className="p-8 relative">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-3xl font-bold text-cyan-300">Portfolio Analytics</h3>
                    </div>
                ...
                >
                  ...
                  <div className="p-8 relative">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-3 rounded-xl bg-pink-500/20 border border-pink-500/50">
                        <Shield className="h-6 w-6 text-pink-400" />
                      </div>
                      <h3 className="text-3xl font-bold text-pink-300">Military-Grade Security</h3>
                    </div>
                    <p className="text-purple-200/80 text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  return (
                    <Card
                      key={index}
                      className="relative overflow-hidden bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md border-2 border-white/20 hover:border-white/40 p-8 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 cursor-pointer group"
                    ...
                    >
                      <div className="relative mb-6">
                        <div className={`p-4 rounded-2xl bg-gradient-to-r ${feature.gradient} inline-block`}>
                      ...
                      <ArrowRight className="absolute bottom-8 right-8 h-6 w-6 text-white/40 group-hover:text-white group-hover:translate-x-2 transition-all" />
                    </Card>
                  )
                })}
              </div>
          ...
          <section className="py-32 px-6 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <p className="text-2xl text-purple-300/80 mb-12 leading-relaxed">
                Join leading financial institutions using AI-powered risk management
              </p>
              <div className="flex gap-6 justify-center">
                <Link href="/login">
                  <Button
                    className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white text-xl px-16 py-8 rounded-2xl font-bold transition-all duration-300 transform hover:scale-110"
                ...
                <Link href="/portfolio">
                  <Button
                    variant="outline"
                    className="border-2 border-pink-500 text-pink-400 hover:bg-pink-500/10 text-xl px-16 py-8 rounded-2xl font-bold transition-all duration-300 transform hover:scale-110 bg-transparent"
